...
const { isLoggedIn } = useAuth()
  ...
  function handleCTA() {
    if (isLoggedIn) { router.push('/') } else { setShowAuth(true) }
  }
  ...
  return (
    <div style={{ fontFamily: "'DM Sans', system-ui, -apple-system, sans-serif" }}>
      ...
      <section style={{ position: 'relative', overflow: 'hidden', background: GREEN_DARK, paddingBottom: 0 }}>
        ...
        <div style={{ position: 'relative', zIndex: 2, maxWidth: 900, margin: '0 auto', padding: '80px 24px 100px', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
            ...
            <Link href="/" style={{ padding: '15px 28px', borderRadius: 10, background: 'rgba(255,255,255,0.12)', border: '1px solid rgba(255,255,255,0.2)', color: WHITE, fontSize: 15, fontWeight: 600, textDecoration: 'none' }}>
              See today's matches
            </Link>
          </div>
      ...
      <footer style={{ background: GREEN_DARK, color: 'rgba(255,255,255,0.6)', padding: '32px 24px', textAlign: 'center', fontSize: 13 }}>
        <Link href="/" style={{ color: WHITE, fontWeight: 700, fontSize: 16, textDecoration: 'none' }}>ratethat.tennis</Link>
