...
import { seedPickedSet } from '../StarPick'
    ...
    return (
      <div style={{ padding: '60px 24px', textAlign: 'center' }}>
        ...
        <p style={{ color: 'var(--text-3)', fontSize: 13 }}>
          ...
          <Link href="/" style={{ color: 'var(--green)', fontWeight: 600 }}>match list</Link>{' '}
                ...
                return (
                  <tr key={p.id} style={{ borderTop: i > 0 ? '1px solid var(--border-faint)' : 'none' }}>
                    ...
                    <td style={{ padding: '8px 12px', fontWeight: 600 }}>
                      <Link href={playerUrl({ id: p.player_id, name: p.picked_player?.name })} style={{ color: 'var(--text)' }}>
