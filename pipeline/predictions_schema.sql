...
CREATE TABLE IF NOT EXISTS player_point_stats (
    ...
    -- Dominance + flow
    love_holds           INTEGER DEFAULT 0,
    love_hold_pct        NUMERIC(5,2),
    avg_service_game_pts NUMERIC(5,2),
    pressure_pts_faced   INTEGER DEFAULT 0,
    pressure_pts_won     INTEGER DEFAULT 0,
    pressure_win_pct     NUMERIC(5,2),
    set1_lost            INTEGER DEFAULT 0,
    set1_lost_recovered  INTEGER DEFAULT 0,
    set1_recovery_pct    NUMERIC(5,2),
    longest_game_run     INTEGER,
    deuce_pts_won_ret    INTEGER DEFAULT 0,
    deuce_pts_total_ret  INTEGER DEFAULT 0,
    deuce_win_pct_ret    NUMERIC(5,2),
    -- Sample size
